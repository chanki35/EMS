...
const ViewHRCompanyEmployees = () => {
  ...
  const retrieveAllUser = async () => {
    const response = await axios.get(
      `${BASE_URL}/api/user/fetch/employee/company-wise?role=Employee&companyId=${hr.company.id}`,
      {
        headers: {
                        ...
                        {(() => {
                          if (employeeUser.employee === null) {
                            return (
                              <button
                                onClick={() =>
                                  addEmployeeDetailPage(employeeUser)
                                }
...
export default ViewHRCompanyEmployees;

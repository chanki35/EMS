          ...
          if (res.success) {
            ...
            if (res.jwtToken !== null) {
              if (res.user.role === "Admin") {
                ...
                sessionStorage.setItem("company-jwtToken", res.jwtToken);
              } else if (res.user.role === "HR") {
                sessionStorage.setItem("active-hr", JSON.stringify(res.user));
                sessionStorage.setItem("hr-jwtToken", res.jwtToken);
